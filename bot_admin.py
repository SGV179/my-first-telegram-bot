...
# Добавьте этот импорт в раздел импортов
from bots.handlers.loyalty_commands import cmd_loyalty, cmd_rewards

# Добавьте эти строки в раздел регистрации обработчиков (после регистрации других команд)
...
async def handle_admin_callback(callback: types.CallbackQuery):
    ...
    if action == "admin_stats":
        ...
        await show_admin_main_menu(callback)  # Добавьте эту строку
...
# Добавьте эту функцию для показа главного меню админ-панели
