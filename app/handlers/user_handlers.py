...
/activities - Показать ваши активности
...
/my_rewards - Показать ваши покупки
...
⚡ Для автоматического отслеживания активностей:
Бот должен быть администратором в каналах с правами на просмотр сообщений.

📊 До настройки используйте /quick_activities для ручного добавления.
    """
